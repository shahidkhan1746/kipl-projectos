...
export const hrApi = {
  ...
  idCardHtml:       (id: string, style = 'template') => api.get('/api/v1/hr/id-card/' + id, { params: { style }, responseType: 'blob' }),
  idCardServerPdf:  (id: string, style = 'template') => api.get('/api/v1/hr/id-card/' + id + '/pdf', { params: { style }, responseType: 'blob' }),
