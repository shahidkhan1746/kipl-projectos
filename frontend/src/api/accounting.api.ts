...
export const accountingApi = {
  ...
  vendorLedger:   (id: string, projectId?: string) => api.get('/api/v1/accounting/vendors/' + id + '/ledger', { params: { projectId } }),
  imprestSummary: (projectId: string) => api.get('/api/v1/accounting/imprest/summary', { params: { projectId } }),
  disburseImprest:(d: any) => api.post('/api/v1/accounting/imprest/disburse', d),
