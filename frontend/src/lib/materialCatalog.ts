...
export const MATERIAL_CATEGORIES: Record<MaterialCategoryId, MaterialCategoryMeta> = {
  ...
  aggregate_sand: {
    ...
    presets: [
      ...
      {
        name: 'Over Gauge (Soling Stone / Boulders)',
        unit: 'cft',
        spec: 'Heavy rock soling and over-gauge boulders for road base, subgrade stabilization and trench bottom soling',
        aliases: [
          'over gauge',
          'overgauge',
          'soling stone',
