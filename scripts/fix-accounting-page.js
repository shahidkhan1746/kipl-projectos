// Run from project root: node scripts/fix-accounting-page.js
const fs = require('fs')
const path = require('path')

const file = path.join('frontend', 'src', 'pages', 'accounting', 'AccountingPage.tsx')
...
console.log('✓ AccountingPage.tsx rewritten cleanly')
console.log('  Tabs: Expenses, Vendors, TDS Ledger, Transactions')
console.log('  No syntax errors — all inline styles, no template literals')
