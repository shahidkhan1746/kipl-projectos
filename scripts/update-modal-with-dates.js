...
const filePath = path.join(
  ...
  'Desktop', 'kipl-srinagar', 'frontend', 'src', 'components', 'ui', 'DataCompletenessModal.tsx'
)
...
console.log('✅ DataCompletenessModal.tsx updated')
console.log('')
console.log('Changes:')
console.log('  ✓ Yes — Confirmed now reveals a date field')
console.log('  ✓ Planned end date shown as reference (e.g. Agreement due 27-Oct-2025)')
console.log('  ✓ Delay days auto-calculated and shown instantly as user types date')
console.log('  ✓ Color coded: green = on time, amber = ≤30d delay, red = >30d delay + EOT')
console.log('  ✓ Delay days saved to system_settings as [key]_delay_days')
console.log('  ✓ Actual date saved as [key]_actual_date')
console.log('  ✓ Save button disabled until date is entered when Yes is selected')
