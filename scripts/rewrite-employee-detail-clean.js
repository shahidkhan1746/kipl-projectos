...
const filePath = path.join(
  ...
  'Desktop', 'kipl-srinagar', 'frontend', 'src', 'pages', 'hr', 'EmployeeDetailPage.tsx'
)
    ...
    <div style={{ display:'flex', flexDirection:'column', gap:24 }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(280px, 1fr))', gap:20 }}>
        ...
        <div style={{ background:C.card, border:'1.5px solid '+C.border, borderRadius:14, padding:'20px 22px' }}>
          ...
          <Row label="Employment Type" value={emp.employmentType?.replace(/_/g,' ').replace(/\b\w/g, (c:string) => c.toUpperCase())} />
...
console.log('✅ EmployeeDetailPage.tsx — clean rewrite complete')
console.log('')
console.log('Fixes applied:')
console.log('  ✓ Null crash fixed — optional chaining on all emp fields')
console.log('  ✓ Modal open prop correct — open={showEdit}')
console.log('  ✓ Responsive width — min(760px, 92vw)')
console.log('  ✓ Icons safe — UserCircle + CurrencyDollar (universal phosphor icons)')
console.log('  ✓ Detail grid responsive — repeat(auto-fit, minmax(280px,1fr))')
console.log('  ✓ Modal form grid responsive — repeat(auto-fit, minmax(200px,1fr))')
