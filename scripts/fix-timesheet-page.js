// Run from project root: node scripts/fix-timesheet-page.js
const fs   = require('fs')
const path = require('path')

const file = path.join('frontend', 'src', 'pages', 'hr', 'TimesheetPage.tsx')
...
console.log('✓ TimesheetPage.tsx rewritten cleanly')
console.log('  Single clean import — no duplicates')
console.log('  Frontend will hot reload automatically')
