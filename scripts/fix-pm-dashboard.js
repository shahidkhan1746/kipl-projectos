// Run from project root: node scripts/fix-pm-dashboard.js
const fs   = require('fs')
const path = require('path')

const SRC  = path.join(__dirname, '..', 'frontend', 'src')
const file = path.join(SRC, 'pages', 'dashboard', 'DashboardPage.tsx')
...
const lines = [
  ...
  "          <div style={{ padding: '8px 14px', borderRadius: 10, background: C.blueBg, border: '1.5px solid ' + C.blueBorder, color: C.blue, fontSize: 12, fontWeight: 600, display: 'flex', alignItems: 'center', gap: 6 }}>",
  "            <Buildings size={13} />",
...
console.log('✓ DashboardPage.tsx rewritten — full PM dashboard')
console.log('  Sections: Project hero, 8 KPIs, recent files, quick actions, status breakdown')
