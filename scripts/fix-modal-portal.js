// Run from project root: node scripts/fix-modal-portal.js
const fs   = require('fs')
const path = require('path')

const SRC  = path.join(__dirname, '..', 'frontend', 'src')
const file = path.join(SRC, 'components', 'ui', 'Modal.tsx')
...
console.log('✓ Modal.tsx fixed — now uses React Portal')
console.log('  Modal will always cover the full screen correctly')
