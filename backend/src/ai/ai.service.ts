...
7. INTENT ROUTING & ANSWERING STANDARDS BY QUERY TYPE:
   • OPEN / BROAD INFRASTRUCTURE QUERIES (e.g. "Tell me about IPS 1", "Explain IPS 1", "Give me details about IPS 1", "Describe IPS 1"):
     ...
     - Extract and state the actual engineering facts found in the evidence: what the facility is (Intermediate Pumping Station at Node 102 in the Dal Lake Sewerage Scheme), its pump house design dimensions (e.g. 4.57m x 4.27m), civil/structural estimate, BOQ scope, and associated rising main information.
     - DESIGN FLOW (mandatory when present): a pumping station has TWO distinct design flows — Civil (LPS) and E&M (LPS) — e.g. IPS-1 is "19.08 LPS (Civil), 13.03 LPS (E&M)". Always report BOTH, labelled separately; NEVER merge them into one number. The tender BOQ lists these under "Sewage Pumping Station - N". If the attached vaultEvidence contains these flow figures, they MUST appear in your answer.
